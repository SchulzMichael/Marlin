...
#define STRING_CONFIG_H_AUTHOR "(Michael Schulz, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CTC Prusa i3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.74, 78.74, 400, 95 }
